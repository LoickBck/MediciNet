...
export const PatientFormValidation = z.object({
  ...
  primaryPhysician: z.string().min(2, "Veuillez sélectionner au moins un médecin"),
  insuranceProvider: z
    .string()
    .min(2, "Le nom de l'assurance/mutuelle doit comporter au moins 2 caractères")
    .max(50, "Le nom de l'assurance doit/mutuelle comporter au maximum 50 caractères"),
  insurancePolicyNumber: z
    .string()
    .min(2, "Le numéro de la police d'assurance/mutuelle doit comporter au moins 2 caractères")
    .max(50, "Le numéro de la police d'assurance doit/mutuelle comporter au maximum 50 caractères"),
