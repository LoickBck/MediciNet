  ...
  return (
    ...
    <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
        ...
        <div className="text-center">
            ...
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-dark-700">
                Foires Aux <span className="text-indigo-600">Questions</span>
            </h3>
            ...
            <ul>
                ...
                <li className="text-left mb-10">
                    <div className="flex flex-row items-start mb-5">
                        <div
                            className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-green-500 text-white border-4 border-white text-xl font-semibold">
                        ...
                        <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                            <h4 className="text-md leading-6 font-medium text-gray-900">Que faire après avoir fais ma demande de rendez-vous ?</h4>
                        </div>
                    </div>

                    <div className="flex flex-row items-start">
                        <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                            <p className="text-gray-700 text-sm">Nous vous contacterons dans les plus brefs délai pour confirmer ou annuler votre rendez-vous. Toutes informations supplémentaires vous sera contacter par message sur votre téléphone mobile, ou par mail.
                            </p>
                        </div>
                        <div
                ...
                <li className="text-left mb-10">
                    <div className="flex flex-row items-start mb-5">
                        ...
                        <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                            <h4 className="text-md leading-6 font-medium text-gray-900">Puis-je prendre plusieurs rendez-vous avec différents médecin ?</h4>
                        </div>
                    </div>

                    <div className="flex flex-row items-start">
                        <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                            <p className="text-gray-700 text-sm">Vous pouvez effictivement
                                prendre plusieurs rendez-vous avec différents médecins à la fois, en utilisant notre application. Pour cela, accédé à la page rendez-vous puis sélectionner le médecin en cliquant sur le nom du médecin dans la liste déroulante.
                            </p>
                        </div>
                        <div
                            className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                ...
                <li className="text-left mb-10">
                    <div className="flex flex-row items-start mb-5">
                        ...
                        <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                            <h4 className="text-md leading-6 font-medium text-gray-900">Si l'heure de mon rendez-vous ne me convient pas ? </h4>
                        </div>
                    </div>

                    <div className="flex flex-row items-start">
                        <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                            <p className="text-gray-700 text-sm">Recommencer la procédure de prise de rendez-vous, et notifiez le dans les remarques spécifiques. De ce fait nous pourrons annuler et reprogrammer votre rendez-vous.
                            </p>
                        </div>
                        <div
                            className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                            <svg height="25px" fill="white" version="1.1" id="Layer_1"
                                xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
                                y="0px" viewBox="0 0 295.238 295.238" xmlSpace="preserve">
                                <g>
                                    <g>
                                        <g>
                                            <path d="M277.462,0.09l-27.681,20.72l-27.838,64.905h-22.386l-8.79-19.048h5.743c10.505,0,19.048-8.452,19.048-18.957V28.571
